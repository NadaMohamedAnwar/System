...
import { fetchActiveDepartments, fetchAllTasks, fetchUsers } from "../Redux/Actions/Action";
                                ...
                                return (
                                    <div key={agent.id} className="agent-task-column">
                                        ...
                                        {tasksForAgent.map((task, idx) => {
                                            ...
                                            const slotHeight = (duration / 60) * 50;
                                            const startOffset = (startMinutes / 60) * 50; // no offset, start at midnight
