...
import { fetchDocuments} from "../Redux/Actions/Action";
                ...
                <div>
                    ...
                    <div className="table-container">
                        ...
                        <div className="head-icon">
                            <h4 className="check-head text-color">Documents</h4>
                            <FontAwesomeIcon
                                    ...
                                    Documents.map((doc) => (
                                        <tr >
                                            ...
                                            <FontAwesomeIcon
                                                    className="icon-edit"
                                                    icon={faEye}
                                                    onClick={() => window.open(`http://agentsys.runasp.net${doc.documentUrl}`, "_blank")}
                                                />
